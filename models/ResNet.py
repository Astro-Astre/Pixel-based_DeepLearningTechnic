...
class ResNet(nn.Module):
    def __init__(self, dataset='cifar10', depth=18, num_classes=data_config.num_class, bottleneck=False):
        ...
        if self.dataset.startswith('cifar'):
            ...
            self.conv1 = nn.Conv2d(data_config.input_channel, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
